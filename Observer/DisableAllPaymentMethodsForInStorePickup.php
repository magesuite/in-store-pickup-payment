...
class DisableAllPaymentMethodsForInStorePickup implements \Magento\Framework\Event\ObserverInterface
{
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        if ($paymentMethod != \MageSuite\InStorePickupPayment\Model\Payment\InStorePickup::PAYMENT_METHOD_INSTOREPICKUPPAYMENT_CODE &&
            $shippingMethod == \Magento\InventoryInStorePickupShippingApi\Model\Carrier\InStorePickup::DELIVERY_METHOD) {
